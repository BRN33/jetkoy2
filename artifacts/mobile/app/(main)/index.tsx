...
export default function JobPoolScreen() {
  ...
  const { data: jobs, isLoading, refetch, isRefetching } = useListJobs({ query: { queryKey: getListJobsQueryKey() } });
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.center}>
              ...
              <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>Şu an iş yok</Text>
            </View>
          }
          renderItem={({ item }) => (
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
              ...
              <View style={styles.detailsRow}>
                <View>
                  ...
                  <Text style={[styles.value, { color: colors.foreground }]}>{item.creatorName} ({item.creatorPlate})</Text>
                </View>
              </View>
              ...
              <View style={styles.footerRow}>
                <View>
                  ...
                  <Text style={[styles.commissionText, { color: colors.mutedForeground }]}>Komisyon: {item.commission} TL</Text>
                </View>
                <Pressable
                  style={({ pressed }) => [
                    styles.grabButton,
...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, justifyContent: "center", alignItems: "center", paddingTop: 100, gap: 16 },
  ...
  grabButton: { paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, justifyContent: "center", alignItems: "center" },
  grabButtonText: { fontWeight: "800", fontSize: 16 },
  fab: { position: "absolute", bottom: 24, right: 24, flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingVertical: 16, borderRadius: 32, gap: 8, elevation: 4, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 8 },
